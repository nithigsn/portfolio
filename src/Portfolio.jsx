export default function Portfolio(){
  ...
  {/*------------------------ Skills --------------------------*/}
  <div className="skills-container" id="section4">
    <h2>Skills</h2>
    <div className="skill-container">
      <div className="row row-1">
        <div className="col">
          <div className="col-box html" />
          <div className="col-box react" />
        </div>
        <div className="col col-2">
          <div className="col-box css">
            <p> Let's Color It</p>
          </div>
          <div className="col-box js" />
        </div>
      </div>
